                            ...
                            <div class="w-full px-3 mb-6">
                                ...
                                <div class="form-check">
                                    <input
                                        ...
                                        type="checkbox" value="1" id="flexCheckDefault" name="primary" {{$room->primary == true ? 'checked' : null}}>
                                    ...
                                    <div class="flex flex-wrap items-center justify-center mb-6">
                                        <div class="mt-2">
                                            <div class="form-check inline-flex mr-6">
                                                <input
                                                    class="form-check-input appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"
                                                    type="checkbox" value="1" name="community_user" id="flexCheckCommunity" {{whereAccessRoom($room->id, \App\Models\User::COMMUNITY) == 1 ? 'checked' : null}}>
                                            ...
                                            <div class="form-check inline-flex">
                                                <input
                                                    class="form-check-input appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"
                                                    type="checkbox" value="1" name="normal_user" id="flexCheckNormal" {{whereAccessRoom($room->id, \App\Models\User::NORMAL) == 1 ? 'checked' : null}}>
                                                <label class="form-check-label inline-block text-gray-800"
                                                       for="flexCheckNormal">
                                                    Normal Kullanıcı
                                                </label>
